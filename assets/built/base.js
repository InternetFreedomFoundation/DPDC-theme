var Zepto = (function () {
  ...
  return (
    ...
    (M.fragment = function (t, e, n) {
      var r, i, o;
      return (
        (r = j.test(t) ? E(C.createElement(RegExp.$1)) : r) ||
          (t.replace && (t = t.replace(D, '<$1></$2>')),
          e === b && (e = B.test(t) && RegExp.$1),
          ((o = k[(e = !(e in k) ? '*' : e)]).innerHTML = '' + t),
    ...
    (M.init = function (t, e) {
      ...
      if ('string' == typeof t)
        if ('<' == (t = t.trim())[0] && B.test(t))
          ...
          if (e !== b) return E(e).find(t);
          n = M.qsa(C, t);
        }
      else {
        if (o(t)) return E(C).ready(t);
        if (M.isZ(t)) return t;
        if (H(t))
          (r = t),
    ...
    (E.fn = {
      ...
      get: function (t) {
        return t === b ? O.call(this) : this[0 <= t ? t : t + this.length];
      },
      toArray: function () {
        return this.get();
      },
      ...
      attr: function (e, n) {
        ...
        return 'string' != typeof e || 1 in arguments
          ? this.each(function (t) {
              if (1 === this.nodeType)
                if (i(e)) for (w in e) m(this, w, e[w]);
      ...
      offset: function (r) {
        ...
        if (
          C.documentElement !== this[0] &&
          !E.contains(C.documentElement, this[0])
        )
          return { top: 0, left: 0 };
      ...
      position: function () {
        if (this.length) {
          var t = this[0],
            e = this.offsetParent(),
            n = this.offset(),
            r = $.test(e[0].nodeName) ? { top: 0, left: 0 } : e.offset();
          return (
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            t && !$.test(t.nodeName) && 'static' == E(t).css('position');
              ...
              (r = a ? e : e.parentNode),
                (e =
                  0 == s
                    ...
                    ? e
                    : null);
              var n = E.contains(C.documentElement, r);
...
(window.Zepto = Zepto),
  ...
  (function (f) {
      ...
      t.split(/\s/).forEach(function (t) {
        ...
        (n.proxy = function (t) {
          if (!(t = m(t)).isImmediatePropagationStopped()) {
            t.data = o;
            var e = r.apply(i, t._args == b ? [t] : [t].concat(t._args));
    ...
    function v(t) {
      var e,
        n = { originalEvent: t };
      for (e in t) i.test(e) || t[e] === b || (n[e] = t[e]);
      return m(n, t);
    }
    function g(t) {
    ...
    (o.click = o.mousedown = o.mouseup = o.mousemove = 'MouseEvents'),
      ...
      (f.proxy = function (t, e) {
        ...
        if (E(t)) {
          function r() {
            return t.apply(e, n ? n.concat(w.call(arguments)) : arguments);
          }
          return (r._zid = l(t)), r;
        }
        if (g(e))
                  ...
                  (u = function (t) {
                    ...
                    return n && n !== r
                      ? ((e = f.extend(v(t), {
                        ...
                        (a || o).apply(n, [e].concat(w.call(arguments, 1))))
                      : void 0;
                  }),
                c(r, e, o, n, i, u || a);
            }));
        ...
        (this._initBody = function (t) {
          if ((this._bodyInit = t))
            if ('string' == typeof t) this._bodyText = t;
              ...
              if (!v || (!ArrayBuffer.prototype.isPrototypeOf(t) && !w(t)))
